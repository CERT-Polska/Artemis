...
class OrmInjectionDetectorReporter(Reporter):
    ORM_INJECTION = ReportType("orm_injection")
    ...
    def create_reports(task_result: Dict[str, Any], language: Language) -> List[Report]:
        ...
        return [
            Report(
                ...
                report_type=OrmInjectionDetectorReporter.ORM_INJECTION,
    ...
    def get_normal_form_rules() -> Dict[ReportType, Callable[[Report], NormalForm]]:
        ...
        return {
            OrmInjectionDetectorReporter.ORM_INJECTION: lambda report: Reporter.dict_to_tuple(
                {
