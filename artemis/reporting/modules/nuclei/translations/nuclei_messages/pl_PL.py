...
TRANSLATIONS = {
    ...
    + REFLECTED_XSS_DESCRIPTION
    + UPDATE_HINT,
    "qdPM 9.2 allows Directory Traversal to list files and directories by navigating to the /uploads URI.": "System qdPM w wersji 9.2 i potencjalnie wcześniejszych zawiera podatność Directory Traversal, umożliwiającą atakującemu odczyt plików z serwera." + UPDATE_HINT,
    "Ruby on Rails before version 5.0.1 is susceptible to remote code execution because it passes user parameters as local variables into partials.": "Ruby on Rails w wersji poniżej 5.0.1 zawiera podatność o identyfikatorze CVE-2020-8163 umożliwiającą atakującemu zdalne wykonanie kodu poprzez przekazanie parametrów użytkownika jako zmiennych lokalnych do części szablonu." + RCE_EFFECT_DESCRIPTION + UPDATE_HINT,
