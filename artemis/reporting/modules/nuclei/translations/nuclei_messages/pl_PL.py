...
TRANSLATIONS = {
    ...
    "[no description] http/vulnerabilities/jenkins/unauthenticated-jenkins.yaml": "Wykryto narzędzie Jenkins publicznie dostępne, które nie wymaga zalogowania. Rekomendujemy, aby nie było ono dostępne publicznie oraz zalecamy włączenie mechanizmu uwierzytelniania, ponieważ może umożliwić atakującemu uruchamianie własnych zadań lub nieuprawniony dostęp do informacji/kodu źródłowego.",
