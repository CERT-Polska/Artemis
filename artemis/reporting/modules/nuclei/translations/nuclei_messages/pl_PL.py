...
TRANSLATIONS = {
    ...
    + UPDATE_HINT,
    "In avatar_uploader v7.x-1.0-beta8 the view.php program doesn't restrict file paths, allowing unauthenticated users to retrieve arbitrary files.": "Narzędzie avatar_uploader w wersji v7.x-1.0-beta8 zawiera podatność, która umożliwia atakującemu odczyt dowolnych plików z serwera." + UPDATE_HINT,
    "cGit < 1.2.1 via cgit_clone_objects has a directory traversal vulnerability when `enable-http-clone=1` is not turned off, as demonstrated by a cgit/cgit.cgi/git/objects/?path=../ request.": "narzędzie cGIT w wersji poniżej 1.2.1 zawiera podatność, która umożliwia atakującemu odczyt dowolnych plików z serwera." + UPDATE_HINT,
    "Patreon WordPress before version 1.7.0 is vulnerable to unauthenticated local file inclusion that could be abused by anyone visiting the site. Exploitation by an attacker could leak important internal files like wp-config.php, which contains database credentials and cryptographic keys used in the generation of nonces and cookies.": "Wtyczka WordPress o nazwie Patreon w wersji poniżej 1.7.0 zawiera podatność, która umożliwia atakującemu odczyt dowolnych plików z serwera." + WORDPRESS_UPDATE_HINT,
    "SAP xMII 15.0 for SAP NetWeaver 7.4 is susceptible to a local file inclusion vulnerability in the GetFileList function. This can allow remote attackers to read arbitrary files via a .. (dot dot) in the path parameter to /Catalog, aka SAP Security Note 2230978.": "SAP xMII 15.0 dla SAP NetWeaver zawiera podatność, która umożliwia atakującemu odczyt dowolnych plików z serwera." + UPDATE_HINT,
    "A Local File inclusion vulnerability in test.php in spreadsheet-reader 0.5.11 allows remote attackers to include arbitrary files via the File parameter.": "Narzędzie spreadsheet-reader w wersji 0.5.11 zawiera podatność, która umożliwia atakującemu odczyt dowolnych plików z serwera." + UPDATE_HINT,
    "WordPress Wordfence 7.4.5 is vulnerable to local file inclusion.": "Wtyczka WordPress o nazwie Wordfence w wersji 7.4.5 zawiera podatność, która umożliwia atakującemu odczyt dowolnych plików z serwera." + WORDPRESS_UPDATE_HINT,
    ...
    "Longjing Technology BEMS API 1.21 is vulnerable to local file inclusion. Input passed through the fileName parameter through the downloads API endpoint is not properly verified before being used to download files. This can be exploited to disclose the contents of arbitrary and sensitive files through directory traversal attacks.": "Narzędzie Longjing Technology BEMS API 1.21 zawiera podatność, która umożliwia atakującemu odczyt dowolnych plików z serwera." + UPDATE_HINT,
    "Surreal ToDo 0.6.1.2 is vulnerable to local file inclusion via index.php and the content parameter.": "Narzędzie Surreal ToDo w wersji 0.6.1.2 zawiera podatność, która umożliwia atakującemu odczyt dowolnych plików z serwera." + UPDATE_HINT,
    "Linear eMerge E3-Series devices are vulnerable to local file inclusion.": "Urządzenia Linear eMerge E3-Series zawierają podatność, która umożliwia atakującemu odczyt dowolnych plików z serwera." + UPDATE_HINT,
    "ZOHO WebNMS Framework before version 5.2 SP1 is vulnerable local file inclusion which allows an attacker to read arbitrary files via a .. (dot dot) in the fileName parameter to servlets/FetchFile.": "ZOHO WebNMS Framework w wersji poniżej 5.2 SP1 zawiera podatność, która umożliwia atakującemu odczyt dowolnych plików z serwera." + UPDATE_HINT,
    "WordPress GraceMedia Media Player plugin 1.0 is susceptible to local file inclusion via the cfg parameter.": "Wtyczka WordPress o nazwie GraceMedia Media Player w wersji 1.0 zawiera podatność, która umożliwia atakującemu odczyt dowolnych plików z serwera." + WORDPRESS_UPDATE_HINT,
    "WordPress Wechat Broadcast plugin 1.2.0 and earlier allows Directory Traversal via the Image.php url parameter.": "Wtyczka WordPress o nazwie Wechat Broadcast plugin w wersji 1.2.0 i wcześniejszych zawiera podatność, która umożliwia atakującemu odczyt dowolnych plików z serwera." + WORDPRESS_UPDATE_HINT,
    "Jeecg P3 Biz Chat 1.0.5 allows remote attackers to read arbitrary files through specific parameters.": "Jeecg P3 Biz Chat 1.0.5 zawiera podatność, która umożliwia atakującemu odczyt dowolnych plików z serwera." + UPDATE_HINT,
    "Webbdesign SL-Studio is vulnerable to local file inclusion.": "Webbdesign SL-Studio zawiera podatność, która umożliwia atakującemu odczyt dowolnych plików z serwera." + UPDATE_HINT,
    "Oracle Fatwire 6.3 suffers from a path traversal vulnerability in the getSurvey.jsp endpoint.": "Oracle Fatwire w wersji 6.3 zawiera podatność, która umożliwia atakującemu odczyt dowolnych plików z serwera." + UPDATE_HINT,
    "Groupoffice 3.4.21 is vulnerable to local file inclusion.": "Groupoffice 3.4.21 zawiera podatność, która umożliwia atakującemu odczyt dowolnych plików z serwera." + UPDATE_HINT,
    "OrbiTeam BSCW Server versions 5.0.x, 5.1.x, 5.2.4 and below, 7.3.x and below, and 7.4.3 and below are vulnerable to unauthenticated local file inclusion.": "OrbiTeam BSCW Server w wersji 5.0.x, 5.1.x, 5.2.4 i wcześniejszych, 7.3.x i wcześniejszych i 7.4.3 i wcześniejszych zawiera podatność, która umożliwia atakującemu odczyt dowolnych plików z serwera." + UPDATE_HINT,
    "Asanhamayesh CMS 3.4.6 is vulnerable to local file inclusion.": "Asanhamayesh CMS w wersji 3.4.6 zawiera podatność, która umożliwia atakującemu odczyt dowolnych plików z serwera." + UPDATE_HINT,
    "Portal do Software Publico Brasileiro i3geo 7.0.5 is vulnerable to local file inclusion in the component codemirror.php, which allows attackers to execute arbitrary PHP code via a crafted HTTP request.": "Portal do Software Publico Brasileiro i3geo 7.0.5 zawiera podatność umożliwiającą zdalne wykonanie kodu." + RCE_EFFECT_DESCRIPTION + UPDATE_HINT,
