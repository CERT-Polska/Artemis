...
TRANSLATIONS = {
    ...
    + REFLECTED_XSS_DESCRIPTION
    + UPDATE_HINT,
    "Detects unauthenticated access to Prometheus Time Series Collection and Processing Server by checking for specific elements in the response from the `/graph` endpoint.": "Wykryto serwer Prometheus skonfigurowany, aby umożliwiać dostęp bez uwierzytelnienia.",
