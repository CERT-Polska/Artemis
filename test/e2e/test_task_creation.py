...
class TaskCreationTestCase(BaseE2ETestCase):
    def test_task_creation_with_module_config(self) -> None:
        # Test data
        test_config = {"severity_threshold": "high_and_above", "max_templates": 1000, "template_list": ["cves"]}
    ...
    def test_task_creation_with_invalid_config(self) -> None:
        ...
        invalid_config = {"severity_threshold": "invalid_level", "max_templates": "not_a_number"}
