...
class MailDNSScannerTest(ArtemisModuleTestCase):
    ...
    def test_simple(self) -> None:
        ...
        self.assertEqual(
            ...
            "Found problems: Valid DMARC record not found. We recommend using all three mechanisms: SPF, DKIM and "
            "DMARC to decrease the possibility of successful e-mail message spoofing., Valid SPF record not found. "
            "We recommend using all three mechanisms: SPF, DKIM and DMARC to decrease the possibility of successful "
            "e-mail message spoofing.",
        )
