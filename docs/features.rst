...
For a detailed guide on using the REST API, including step-by-step examples for adding targets, monitoring scans, and retrieving results, see :ref:`rest-api`.
