...
If you want to translate the notification e-mails generated by Artemis (described in
https://artemis-scanner.readthedocs.io/en/latest/user-guide/quick-start.html#generating-e-mails),
update the translation files by using:
