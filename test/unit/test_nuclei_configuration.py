...
class TestNucleiConfiguration(unittest.TestCase):
    ...
    def test_init_with_custom_values(self) -> None:
        ...
        config = NucleiConfiguration(
            enabled=False, severity_threshold=SeverityThreshold.HIGH_AND_ABOVE, max_templates=100
        )
    ...
    def test_serialize(self) -> None:
        ...
        config = NucleiConfiguration(
            enabled=False, severity_threshold=SeverityThreshold.LOW_AND_ABOVE, max_templates=50
        )
    ...
    def test_deserialize(self) -> None:
        ...
        config_dict: Dict[str, Any] = {"enabled": False, "severity_threshold": "high_and_above", "max_templates": 200}
    ...
    def test_validate_valid_config(self) -> None:
        ...
        config = NucleiConfiguration(enabled=True, severity_threshold=SeverityThreshold.ALL, max_templates=100)
