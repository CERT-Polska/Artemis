...
TRANSLATIONS = {
    ...
    + REFLECTED_XSS_DESCRIPTION
    + UPDATE_HINT,
    "Joomla! Omilen Photo Gallery (com_omphotogallery) component Beta 0.5 allows remote attackers to include and execute arbitrary local files via directory traversal sequences in the controller parameter to index.php.": "Komponent Joomla! Omilen Photo Gallery (com_omphotogallery) w wersji Beta 0.5 i potenjcalnie wcześniejszych umożliwia atakującemu odczyt i wykonanie dowolnych plików na dysku serwera.",
