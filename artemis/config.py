...
class Config:
    class Data:
        ...
        class Autoarchiver:
            ...
            AUTOARCHIVER_MIN_AGE_SECONDS_NOT_INTERESTING: Annotated[
                ...
                "AUTOARCHIVER_MIN_AGE_SECONDS_NOT_INTERESTING", default=7 * 24 * 60 * 60, cast=int
            )  # 30 days
    ...
    class Miscellaneous:
        ...
        MODULES_DISABLED_BY_DEFAULT: Annotated[
            ...
            default="admin_panel_login_bruter,dangling_dns_detector,example,humble,ssh_bruter,xss_scanner",
