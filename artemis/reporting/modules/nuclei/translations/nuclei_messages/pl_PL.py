...
TRANSLATIONS = {
    ...
    + WORDPRESS_UPDATE_HINT,
    "WordPress Adaptive Images < 0.6.69 is susceptible to cross-site scripting because the plugin does not sanitize and escape the REQUEST_URI before outputting it back in a page.": "Wtyczka WordPress o nazwie Adaptive Images w wersji poniżej 0.6.69 zawiera podatność Cross-Site Scripting" + REFLECTED_XSS_VULNERABILITY_DESCRIPTION
    + WORDPRESS_UPDATE_HINT,
    ...
    + UPDATE_HINT,
    "WordPress Custom Tables 3.4.4 plugin contains a cross-site scripting vulnerability via the key parameter.": "Wtyczka WordPress o nazwie Custom Tables w wersji 3.4.4 zawiera podatność Cross-Site Scripting" + REFLECTED_XSS_VULNERABILITY_DESCRIPTION
    + WORDPRESS_UPDATE_HINT,
