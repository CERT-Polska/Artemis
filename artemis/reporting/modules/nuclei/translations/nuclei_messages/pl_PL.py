...
TRANSLATIONS = {
    ...
    + RCE_EFFECT_DESCRIPTION
    + UPDATE_HINT,
    Wykryto podatność CVE-2023-6549 umożliwiającą atakującemu zdalne uzyskanie wrażliwych informacji z urządzenia NetScaler skonfigurowanego jako Gateway lub serwer wirtualny AAA bez konieczności uwierzytelniania." + UPDATE_HINT,
    "Wykryto system WordPress zawierający podatność typu blind SSRF (identyfikator CVE-2022-3590) niewymagającą uwierzytelnienia. Aakujący mogą wysyłać żądania HTTP do hostów w sieci wewnętrznej (bez możliwości odczytu odpowiedzi)." + UPDATE_HINT,
    "OpenCTI 3.3.1 is vulnerable to local file inclusion.": OpenCTI w wersji 3.3.1 i potencjalnie wcześniejszych zawiera podatność umożliwiającą atakującemu odczyt dowolnych plików z dysku." + UPDATE_HINT,
