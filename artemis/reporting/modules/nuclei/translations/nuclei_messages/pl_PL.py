...
TRANSLATIONS = {
    ...
    + RCE_EFFECT_DESCRIPTION,
    "Microsoft Exchange Server is vulnerable to a remote code execution vulnerability. This CVE ID is unique from CVE-2021-31196, CVE-2021-31206.": "Wykryto, że Microsoft Exchange Server umożliwia zdalne wykonanie kodu."
    + RCE_EFFECT_DESCRIPTION
    + UPDATE_HINT,
