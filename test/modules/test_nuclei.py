...
class NucleiTest(ArtemisModuleTestCase):
    ...
    def test_simple(self) -> None:
        ...
        self.assertEqual(
            ...
            "[high] http://test-phpmyadmin-easy-password:80: phpMyAdmin - Default Login phpMyAdmin contains a "
            "default login vulnerability. An attacker can obtain access to user accounts and access sensitive "
            "information, modify data, and/or execute unauthorized operations., [info] http://test-phpmyadmin-"
            "easy-password:80: phpMyAdmin Panel - Detect phpMyAdmin panel was detected.",
        )
