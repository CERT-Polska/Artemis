...
class TestTaskTemplate(ArtemisModuleTestCase):
    ...
    def test_task_template_with_breadcrumb_navigation(self, mock_get_template: Mock) -> None:
        ...
        task_data: Dict[str, Any] = {
            ...
            "task": {
                ...
                "headers": {"type": "SERVICE", "receiver": "nuclei", "origin": "classifier"},
                "priority": "normal",
            },
        ...
        task_path: List[Dict[str, Any]] = [
            {
                "id": "root-task-id",
                "task": {"headers": {"type": "NEW"}, "parent_uid": None},
                "target_string": "example.com",
            },
            {
                "id": "parent-task-id",
                "task": {"headers": {"type": "DOMAIN"}, "parent_uid": "root-task-id"},
                "target_string": "example.com",
            },
        ]
    ...
    def test_task_template_with_empty_path(self) -> None:
    ...
    def test_task_template_preserves_existing_functionality(self) -> None:
        """Test that existing template functionality still works"""
        task_data: Dict[str, Any] = {
            "id": "test-task-id",
            "task": {"headers": {"type": "SERVICE", "receiver": "nuclei", "origin": "classifier"}, "priority": "high"},
            "target_string": "example.com:80",
            "analysis_id": "analysis-123",
            "status": "ERROR",
