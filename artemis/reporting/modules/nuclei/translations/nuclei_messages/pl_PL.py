...
TRANSLATIONS = {
    ...
    + UPDATE_HINT,
    "Detected the presence of a .credentials file and extracts sensitive authentication tokens, passwords, or API keys.": "Wykryto plik .credentials zawierający tokeny dostępowe, klucze API lub hasła." + DATA_HIDE_HINT,
