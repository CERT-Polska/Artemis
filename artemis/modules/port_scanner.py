...
from artemis.utils import check_output_and_print_content_on_error, throttle_request
    ...
    def _scan(self, target_ip: str) -> Dict[str, Dict[str, Any]]:
        ...
        for line in lines:
            ...
            output = throttle_request(
                lambda: check_output_and_print_content_on_error(["fingerprintx", "--json"], input=line).strip()
            )
