...
TRANSLATIONS = {
    ...
    "http/exposures/configs/zend-config-file.yaml": "Wykryto plik konfiguracyjny systemu Zend zawierający dane logowania do bazy danych." + DATA_HIDE_HINT,
