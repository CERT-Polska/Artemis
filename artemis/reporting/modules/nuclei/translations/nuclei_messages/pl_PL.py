...
TRANSLATIONS = {
    ...
    + RCE_EFFECT_DESCRIPTION,
    "SuiteCRM is susceptible to the Installation page exposure due to misconfiguration.": "System SuiteCRM zawiera błąd konfiguracji polegający na publicznym udostępnieniu strony instalacyjnej."
    + RESOURCES_HIDE_HINT,
