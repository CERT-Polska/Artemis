...
TRANSLATIONS = {
    ...
    + RCE_EFFECT_DESCRIPTION
    + UPDATE_HINT,
    "Hasura GraphQL Engine is vulnerable to SSRF( Server Side Request Forgery )": "Wykryto oprogramowanjie Hasura GraphQL Engine w wersji zawierającej podatność Server-Side Request Foregery umożlwiającą atakującemu wykonywanie żądań do usług w sieci lokalnej.",
