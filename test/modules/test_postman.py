...
class PostmanTest(ArtemisModuleTestCase):
    ...
    def test_simple(self) -> None:
        task = Task(
            ...
            payload={"host": "test-smtp-server.artemis", "port": 25},
        )
        self.run_task(task)
        ...
        self.assertEqual(
            ...
            "Found problems: possible to send e-mails without autorisation (from @test-smtp-server.artemis), the server is an open relay",
        )
