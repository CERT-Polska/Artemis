...
def print_long_unseen_report_types(reports: List[Report], threshold_days: int = 20) -> None:
    ...
    This is to detect a situation where a eport type stops being generated due to a bug.
    """
    last_seen = {}
