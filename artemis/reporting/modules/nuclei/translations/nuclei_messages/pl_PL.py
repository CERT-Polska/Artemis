...
TRANSLATIONS = {
    ...
    "A Joomla! database directory /libraries/joomla/database/ was found exposed and has directory indexing enabled.": "Wykryto listing plików w katalogu /libraries/joomla/database/. " + DIRECTORY_INDEX_HINT,
    "A MySQL dump file was found": "Wykryto zrzut bazy danych MySQL." + DATA_HIDE_HINT,
    "WordPress theme with a 'Mega-Theme' design is vulnerable to a reflected XSS attack through the '?s=' parameter.": "Wykryto szablon WordPress oparty na Mega-Theme zawiera podatność Cross-Site Scripting, umożliwiającą atakującemu spreparowanie linku, który - kliknięty przez użytkownika - wykona dowolną akcję z jego uprawnieniami.",
    ...
    "Webalizer log analyzer configuration was detected.": "Wykryto konfigurację analizera logów Webalizer." + DATA_HIDE_HINT,
