...
class TestSeverityThreshold(unittest.TestCase):
    ...
    def test_get_severity_list_critical_only(self):
    ...
    def test_get_severity_list_high_and_above(self):
    ...
    def test_get_severity_list_medium_and_above(self):
    ...
    def test_get_severity_list_low_and_above(self):
    ...
    def test_get_severity_list_all(self):
    ...
    def test_get_severity_list_invalid(self):
        ...
        with self.assertRaises(ValueError):
            ...
            SeverityThreshold.get_severity_list("invalid")
