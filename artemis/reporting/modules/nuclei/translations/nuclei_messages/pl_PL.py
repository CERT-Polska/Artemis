...
TRANSLATIONS = {
    ...
    + REFLECTED_XSS_DESCRIPTION
    + UPDATE_HINT,
    'rack-mini-profiler is prone to environmental information disclosure which could help an attacker formulate additional attacks.': "Wykryto narzędzie rack-mini-profiler skonfigurowane tak, aby udostępniać informacje o konfiguracji systemu.",
