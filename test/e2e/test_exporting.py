                ...
                print(
                    ...
                    b"\n".join(
                        [
                            ...
                            b"    <body>",
                            b"        <ol>",
                            b"    <li>NastÄ\x99pujÄ\x85ce domeny nie majÄ\x85 poprawnie skonfigurowanych mechanizmÃ³w weryfikacji nadawcy wiadomoÅ\x9bci e-mail:        <ul>",
                            b"                    <li>",
                            b"                        test-smtp-server.artemis:",
                            b"",
                            b"                            Nie znaleziono poprawnego rekordu DMARC. Rekomendujemy uÅ¼ywanie wszystkich trzech mechanizmÃ³w: SPF, DKIM i DMARC, aby zmniejszyÄ\x87 szansÄ\x99, Å¼e sfaÅ\x82szowana wiadomoÅ\x9bÄ\x87 zostanie zaakceptowana przez serwer odbiorcy.",
                            b"                        ",
                            b"                    </li>",
                            b"        </ul>",
                            b"        <p>",
                            b"            WdroÅ¼enie tych mechanizmÃ³w znaczÄ\x85co zwiÄ\x99kszy szansÄ\x99, Å¼e serwer odbiorcy odrzuci sfaÅ\x82szowanÄ\x85 wiadomoÅ\x9bÄ\x87 e-mail z powyÅ¼szych domen. W serwisie <a href='https://bezpiecznapoczta.cert.pl'>https://bezpiecznapoczta.cert.pl</a> moÅ¼na zweryfikowaÄ\x87 poprawnoÅ\x9bÄ\x87 implementacji mechanizmÃ³w weryfikacji nadawcy poczty w PaÅ\x84stwa domenie.<br/><br/>WiÄ\x99cej informacji o dziaÅ\x82aniu mechanizmÃ³w weryfikacji nadawcy moÅ¼na znaleÅºÄ\x87 pod adresem <a href='https://cert.pl/posts/2021/10/mechanizmy-weryfikacji-nadawcy-wiadomosci'>https://cert.pl/posts/2021/10/mechanizmy-weryfikacji-nadawcy-wiadomosci</a>.",
                            b"            Nawet w przypadku domeny niesÅ\x82uÅ¼Ä\x85cej do wysyÅ\x82ki poczty rekordy SPF i DMARC sÄ\x85 potrzebne w celu ograniczenia moÅ¼liwoÅ\x9bci podszycia siÄ\x99 pod niÄ\x85. Odpowiednia konfiguracja jest opisana w powyÅ¼szym artykule.",
                            b"        </p>",
                            b"    </li>",
                            b"        </ol>",
                            b"    </body>",
