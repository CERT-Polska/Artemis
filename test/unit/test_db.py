...
class TestDB(unittest.TestCase):
    ...
    def test_get_task_path_single_task(self, mock_get_task_by_id: Any) -> None:
    ...
    @patch("artemis.db.DB.get_task_by_id")
    def test_get_task_path_with_parent(self, mock_get_task_by_id: Any) -> None:
        """Test get_task_path for a task with one parent"""
        child_task = {"id": "child", "task": {"parent_uid": "parent"}}
    ...
    @patch("artemis.db.DB.get_task_by_id")
    def test_get_task_path_with_grandparent(self, mock_get_task_by_id: Any) -> None:
        """Test get_task_path for a task with grandparent"""
        grandchild = {"id": "grandchild", "task": {"parent_uid": "child"}}
        child = {"id": "child", "task": {"parent_uid": "parent"}}
    ...
    @patch("artemis.db.DB.get_task_by_id")
    def test_get_task_path_nonexistent_task(self, mock_get_task_by_id: Any) -> None:
    ...
    @patch("artemis.db.DB.get_task_by_id")
    def test_get_task_path_broken_chain(self, mock_get_task_by_id: Any) -> None:
        """Test get_task_path when parent doesn't exist"""
        child_task = {"id": "child", "task": {"parent_uid": "missing_parent"}}
