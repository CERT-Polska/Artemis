...
TRANSLATIONS = {
    ...
    + UPDATE_HINT,
    "The Oracle Access Manager  portion of Oracle Fusion Middleware (component: OpenSSO Agent) is vulnerable to remote code execution. Supported versions that are affected are 11.1.2.3.0, 12.2.1.3.0 and 12.2.1.4.0. This is an easily exploitable vulnerability that allows unauthenticated attackers with network access via HTTP to compromise Oracle Access Manager.": "Komponent OpenSSO Agent narzędzia Oracle Fusion Middleware w wersjach 11.1.2.3.0, 12.2.1.3.0 i 12.2.1.4.0 umożliwia atakującemu zdalne wykonanie kodu." + RCE_EFFECT_DESCRIPTION + UPDATE_HINT,
