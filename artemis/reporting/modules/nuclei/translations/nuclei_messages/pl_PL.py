...
TRANSLATIONS = {
    ...
    + REFLECTED_XSS_DESCRIPTION
    + UPDATE_HINT,
    "GateOne 1.1 allows arbitrary file retrieval without authentication via /downloads/.. local file inclusion because os.path.join is incorrectly used.": "GateOne w wersji 1.1 i potencjalnie wcześniejszych umożliwia atakującemu pobieranie dowolnych plików z dysku serwera." + UPDATE_HINT,
