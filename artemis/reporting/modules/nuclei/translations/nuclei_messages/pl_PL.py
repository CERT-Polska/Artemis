...
TRANSLATIONS = {
    ...
    + RCE_EFFECT_DESCRIPTION
    + UPDATE_HINT,
    'JavaMelody is a tool used to monitor Java or Java EE applications in QA and production environments. JavaMelody was detected on this web application. One option in the dashboard is to "View http sessions". This can be used by an attacker to steal a user\'s session.': "Wykryto publicznie dostępny system JavaMelody, za pomocą którego atakujący może przejąć sesję zalogowanego użytkownika.",
